...
try {
    ...
    console.log("Connected to the ABRO_MD Whatsapp Bot By ABRO TECH")
} catch {
...
setTimeout(() => {
    ...
    global.slogo = 'https://imgur.com/7doiWDc.jpg'
    global.sgc = ''
    global.srepo = 'https://github.com/Temitopeareo/ABROMD1'
    global.scap = '*★ᴘᴏᴡᴇʀᴇᴅ ʙʏ★ ABRO MD* '
...
app.listen(port, () => console.log(`ABRO-MD Server listening on port http://localhost:${port}!`));
